          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { name: "GitHub", handle: "@ntuananhdevs", url: "https://github.com/ntuananhdevs" },
                  { name: "Facebook", handle: "ntuananh", url: "https://www.facebook.com/ntuananh.vn" },
                  { name: "Telegram", handle: "@ntuananh", url: "https://t.me/ntuananh" },
                ].map((social) => (
                  <Link
                    key={social.name}
                    href={social.url}
